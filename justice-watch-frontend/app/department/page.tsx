  ...
  const DepartmentInstances: DepartmentInstance[] = [
    {
      ...
      department_image:
        "https://dallaspolice.net/PublishingImages/badge-dpd.png",
    },
    {
      agency_name: "houston",
