    ...
    <div className="min-h-screen bg-white text-black overflow-y-auto">
      ...
      <div className="max-w-3xl mx-auto mt-16 text-left px-4">
        <h1 className="text-3xl font-bold ">
          Uphold police accountability, one <span className="text-[#D92552]">agency</span>, piece of <span className="text-[#D92552]">legislation</span>, and <span className="text-[#D92552]">incident</span> at a time.
        </h1>
        <p className="mt-4 text-center mt-14">
          Search across thousands of U.S. records, or visit your city's scorecard, <span className="font-bold">here &gt;</span>
        </p>
      ...
      <div className="max-w-3xl mx-auto mt-12 px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <span className="text-sm text-gray-600">INCIDENT</span></div>
          </Link>
          ...
          <div className="bg-gray-200 p-4 rounded-lg cursor-pointer hover:bg-gray-300 flex flex-col justify-between h-full">
              ...
              <span className="text-sm text-gray-600">AGENCY</span></div>
            </Link>
